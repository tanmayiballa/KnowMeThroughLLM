...
def sidebar():
    ...
    st.sidebar.markdown("<p style='text-align: center;'><strong>Data Scientist || Data Analyst || Machine Learning Engineer</strong></p>", unsafe_allow_html=True)
    st.sidebar.markdown("<p style='text-align: center; color: blue'><strong>tballa@iu.edu || +1 812-778-4651 </strong></p>", unsafe_allow_html=True)
    st.sidebar.markdown(
